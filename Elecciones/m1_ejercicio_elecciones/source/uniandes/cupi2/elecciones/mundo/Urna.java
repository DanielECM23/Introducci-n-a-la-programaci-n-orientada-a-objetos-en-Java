...
public class Urna
{
    ...
    public double calcularPorcentajeVotosPorInternetCandidato1() {
        int totalInternet = calcularTotalVotosInternet();
        if (totalInternet == 0) return 0.0;
        return (double) candidato1.darVotosInfluenciaInternet() * 100.0 / totalInternet;
    }

    public double calcularPorcentajeVotosPorInternetCandidato2() {
        int totalInternet = calcularTotalVotosInternet();
        if (totalInternet == 0) return 0.0;
        return (double) candidato2.darVotosInfluenciaInternet() * 100.0 / totalInternet;
    }

    public double calcularPorcentajeVotosPorInternetCandidato3() {
        int totalInternet = calcularTotalVotosInternet();
        if (totalInternet == 0) return 0.0;
        return (double) candidato3.darVotosInfluenciaInternet() * 100.0 / totalInternet;
    }
