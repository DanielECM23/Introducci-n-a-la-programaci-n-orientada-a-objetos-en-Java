...
public class Pasajero
{
    ...
    public void agregarPelicula(String nombre, String genero, int duracion, String director)
    {
    	 if(nombre != null && !nombre.equals("") &&
    		       ...
    		       duracion > 0)
    		    {
    		        Pelicula nueva = new Pelicula(nombre, genero,  duracion, director);
    		        peliculas.add(nueva);
    		    }
    		    else
    		    {
    		        System.out.println("Parámetros inválidos al agregar película.");
    		    }
    }
    ...
    public ArrayList darPeliculasGenero(String genero)
    {
        ...
        for (Pelicula p : peliculas) {
            if (p.darGenero().equalsIgnoreCase(genero)) {
                resultado.add(p);
            }
        }
